<template>
  <div class="container">
    <div class="control-box">
      <o-field class="mb-4" label="Simple">
      ...
      <o-field class="mb-4" label="Grouped">
      ...
      <o-field class="mb-4" label="Error" type="is-danger" message="Something went wrong with this field">
      ...
      <o-field class="mb-4" label="Rounded">
      ...
      <o-field class="mb-4" label="Required">
        <o-select placeholder="Select a character" required>
          <option value="flint">Flint</option>
          <option value="silver">Silver</option>
        </o-select>
      </o-field>
      ...
      <o-field class="mb-4" label="Disabled option">
        <o-select placeholder="Select a character">
          <option value="flint">Flint</option>
      ...
      <o-field class="mb-4" label="Expanded">
